"""
new fields ssa decomposition - ORM
Date: 2025-08-20
"""
...
description = "new fields ssa decomposition - ORM"
depends_on = "016"
auto_generated = True
schema_changes = {
    "ConfigKernel.ts_preprocessing_properties": {
        ...
        "is_new": 0,
        "added_columns": {
            "ssa_window_length": "Nullable(UInt32)",
            "ssa_n_components_used": "Nullable(UInt32)",
            "ssa_variance_explained": "Nullable(Float64)"
        },
        "removed_columns": {},
        "changed_columns": {},
        "affected_tables": [
...
def upgrade(client_session):
    ...
    added_columns = {'ssa_window_length': 'Nullable(UInt32)', 'ssa_n_components_used': 'Nullable(UInt32)', 'ssa_variance_explained': 'Nullable(Float64)'}

    print(f"Adding columns {'ssa_window_length', 'ssa_n_components_used', 'ssa_variance_explained'} to ConfigKernel.ts_preprocessing_properties")
...
def downgrade(client_session):
    ...
    columns_to_remove = ['ssa_window_length', 'ssa_n_components_used', 'ssa_variance_explained']

    print(f"Removing columns {'ssa_window_length', 'ssa_n_components_used', 'ssa_variance_explained'} from ConfigKernel.ts_preprocessing_properties")
