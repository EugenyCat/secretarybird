"""
table ts_preprocessing_properties, new fields data_quality_score and series_type
Date: 2025-05-28
"""
...
description = "table ts_preprocessing_properties, new fields data_quality_score and series_type"
depends_on = "009"
auto_generated = True
schema_changes = {
...
def upgrade(client_session):
    ...
    added_columns = {'data_quality_score': 'Nullable(Float64)', 'series_type': 'Nullable(String)'}

    print(f"Adding columns {'data_quality_score', 'series_type'} to ConfigKernel.ts_preprocessing_properties")
...
def downgrade(client_session):
    ...
    columns_to_remove = ['data_quality_score', 'series_type']

    print(f"Removing columns {'data_quality_score', 'series_type'} from ConfigKernel.ts_preprocessing_properties")
