"""
rename and remove fields in table TSPreprocessingProperties for periodicity - ORM
Date: 2025-05-15
"""
...
description = "rename and remove fields in table TSPreprocessingProperties for periodicity - ORM"
depends_on = "005"
auto_generated = True
schema_changes = {
...
def upgrade(client_session):
    ...
    added_columns = {'periodicity_estimator_params': 'Nullable(String)'}

    print(f"Adding columns {'periodicity_estimator_params'} to ConfigKernel.ts_preprocessing_properties")
    ...
    removed_columns = {'period_candidates': 'Nullable(String)', 'estimator_params': 'Nullable(String)'}

    print(f"Removing columns {'period_candidates', 'estimator_params'} from ConfigKernel.ts_preprocessing_properties")
...
def downgrade(client_session):
    ...
    columns_to_remove = ['periodicity_estimator_params']
    ...
    print(f"Restoring columns {'period_candidates', 'estimator_params'} to ConfigKernel.ts_preprocessing_properties")
