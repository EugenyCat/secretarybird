"""
table ts_preprocessing_properties, new field stl_trend_strength
Date: 2025-05-27
"""
...
description = "table ts_preprocessing_properties, new field stl_trend_strength"
depends_on = "008"
auto_generated = True
schema_changes = {
    "ConfigKernel.ts_preprocessing_properties": {
        ...
        "is_new": 0,
        "added_columns": {
            "stl_trend_strength": "Nullable(Float64)"
        },
        "removed_columns": {},
        "changed_columns": {},
        "affected_tables": [
...
def upgrade(client_session):
    ...
    added_columns = {'stl_trend_strength': 'Nullable(Float64)'}

    print(f"Adding columns {'stl_trend_strength'} to ConfigKernel.ts_preprocessing_properties")
...
def downgrade(client_session):
    ...
    columns_to_remove = ['stl_trend_strength']

    print(f"Removing columns {'stl_trend_strength'} from ConfigKernel.ts_preprocessing_properties")
