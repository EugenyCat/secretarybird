...
from etl_pipeline.helpers.db_funcs_ml import DBFuncsML
from etl_pipeline.ml_models.modelFactory import ModelFactory
from etl_pipeline.ml_manager.modelTrainerManager import ModelTrainer
from etl_pipeline.ml_manager.modelEvaluatorManager import ModelEvaluator
from etl_pipeline.ml_manager.modelRegistryManager import modelRegistryManager
from etl_pipeline.optimizers.hyperparameterOptimizer import HyperparameterOptimizer
import json
import os
import logging
...
class ModelAutomationManager(ConfigurationBuilder):
    ...
    def setup(self):
        ...
        try:
            ...
            self.set_data(db_funcs.get_data())
            ...
            # TODO: Implement Bayesian Optimization, Optuna, and Ray Tune, and evaluate which performs best.
            # TODO: Ensure that the optimizer's interface aligns with the ML model's API.
            self.optimizer = HyperparameterOptimizer(self.modelname, hyperparam_space, self.data)
